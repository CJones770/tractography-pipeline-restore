...
sed echo 's/$/ '$ReadOut'/' /opt/Pipeline/Pipeline/Pipeline/ACQP/ap_template_min.txt > /opt/Pipeline/Pipeline/Pipeline/ACQP/sub_"$zi"/acquisition_parameters_min.txt
#cat > acquisition_parameters_min.txt \
#'s/$/ '$ReadOut'/' \
#
