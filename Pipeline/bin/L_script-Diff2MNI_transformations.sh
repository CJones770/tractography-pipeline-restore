...
calculate_transf () {
  ...
  /usr/local/fsl/bin/flirt -in /opt/Pipeline/Pipeline/Pipeline/Stg4Tmp/sub_$zi/BedpostX_"$zi".bedpostX/nodif_brain \
  ...
  /usr/local/fsl/bin/convert_xfm -omat /opt/Pipeline/Pipeline/Pipeline/Stg4Tmp/sub_$zi/BedpostX_"$zi".bedpostX/xfms/str2diff.mat \
-inverse /opt/Pipeline/Pipeline/Pipeline/Stg4Tmp/sub_$zi/BedpostX_"$zi".bedpostX/xfms/diff2str.mat 
  ...
  /usr/local/fsl/bin/flirt -in /opt/Pipeline/Pipeline/Pipeline/Stg3Tmp/sub_$zi/sub-"$zi"_T1bet.nii.gz \
  ...
  /usr/local/fsl/bin/convert_xfm -omat /opt/Pipeline/Pipeline/Pipeline/Stg4Tmp/sub_$zi/BedpostX_"$zi".bedpostX/xfms/standard2str.mat \
  ...
  /usr/local/fsl/bin/convert_xfm -omat /opt/Pipeline/Pipeline/Pipeline/Stg4Tmp/sub_$zi/BedpostX_"$zi".bedpostX/xfms/diff2standard.mat \
  ...
  /usr/local/fsl/bin/convert_xfm -omat /opt/Pipeline/Pipeline/Pipeline/Stg4Tmp/sub_$zi/BedpostX_"$zi".bedpostX/xfms/standard2diff.mat \
...
--config=T1_2_MNI152_2mm
  ...
  /usr/local/fsl/bin/invwarp -w /opt/Pipeline/Pipeline/Pipeline/Stg4Tmp/sub_$zi/BedpostX_"$zi".bedpostX/xfms/str2standard_warp \
  ...
  /usr/local/fsl/bin/convertwarp -o /opt/Pipeline/Pipeline/Pipeline/Stg4Tmp/sub_$zi/BedpostX_"$zi".bedpostX/xfms/diff2standard_warp \
  -r /usr/local/fsl/data/standard/MNI152_T1_2mm -m /opt/Pipeline/Pipeline/Pipeline/Stg4Tmp/sub_$zi/BedpostX_"$zi".bedpostX/xfms/diff2str.mat \
  ...
  /usr/local/fsl/bin/convertwarp -o /opt/Pipeline/Pipeline/Pipeline/Stg4Tmp/sub_$zi/BedpostX_"$zi".bedpostX/xfms/standard2diff_warp \
...
echo "Running registration for subject $zi...."
