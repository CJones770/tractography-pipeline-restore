...
mkdir $2/sub_$zi/BedpostX_"$zi".bedpostX/logs/logs_gpu/
...
cp /opt/Pipeline/Pipeline/Pipeline/Stg4Tmp/sub_$zi/BedpostX_"$zi".bedpostX/logs/logs_gpu/* $2/sub_$zi/BedpostX_"$zi".bedpostX/logs/logs_gpu/
