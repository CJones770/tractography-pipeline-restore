...
do
zi=$( printf '%02d' "$i")
mrdegibbs ~/Pipeline/Stg1Tmp/sub_$zi/107-AP_denoised.nii ~/Pipeline/Stg1Tmp/sub_$zi/d107-AP_DNDG.nii.gz	
mrdegibbs ~/Pipeline/Stg1Tmp/sub_$zi/107-PA_denoised.nii ~/Pipeline/Stg1Tmp/sub_$zi/d107-PA_DNDG.nii.gz
now=$(date +"%T")
